...
# အစ်ကို့၏ AQ... Key အသစ်ကို ရိုးရိုးရှင်းရှင်း တိုက်ရိုက်အသုံးပြုခြင်း (Enterprise စနစ် မဟုတ်ပါ)
GOOGLE_API_KEY = "AQ.Ab8RN6K4EirRIdueVdPXCvtvz-y2JpoSwPJiPVqICEk2hk6Eww" 
...
def extract_data_with_ai(images):
    ...
    # ရိုးရိုး AI Studio Model ကိုသာ ခေါ်ယူခြင်း
